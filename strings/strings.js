...
console.log("Jut make sure you use double quotes\" or '");
console.log('this is an example of using an \'');
...
console.log("the \\ is called an escape charcter");
...
console.log("notice thatspaces count as characters");
...
console.log("The index of de is " + index.example.indexOf("de"));
